...
const PeoplePieCharts: React.FC<Props> = (props: any) => {
        ...
        series: [
          {
            ...
            data: [
              {
                value: data?.filter((i: any) => i.name === '男')?.[0]?.value,
                symbol: symbols[0],
                itemStyle: {
                  normal: {
              ...
              {
                value: data?.filter((i: any) => i.name === '女')?.[0]?.value,
                symbol: symbols[1],
                itemStyle: {
                  normal: {
...
export default PeoplePieCharts;
