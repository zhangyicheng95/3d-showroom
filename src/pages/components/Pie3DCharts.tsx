      ...
      function getPie3D(pieData: any, internalDiameterRatio: any) {
        ...
        for (let i = 0; i < pieData.length; i += 1) {
          ...
          const seriesItem: any = {
            ...
            //       { offset: 1, color: lineColorList[i % lineColorList?.length][0] },
            //     ])
            //   }
            // },
            pieData: {
              ...pieData[i],
              color: new echarts.graphic.LinearGradient(0, 0, 1, 0, [
                { offset: 0, color: lineColorList[i % lineColorList?.length][0] },
                { offset: 1, color: lineColorList[i % lineColorList?.length][1] },
              ]),
            },
            pieStatus: {
              selected: false,
